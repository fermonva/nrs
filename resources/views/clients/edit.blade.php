                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="first_name" class="block mt-1 w-full" type="text" name="first_name"
                                value="{{ $client->first_name }}" required autofocus />
                        </div>
                        ...
                        <div>
                            ...
                            <select id="gas_quality_id" name="gas_quality_id" class="block mt-1 w-full" required>
                                ...
                                <option value="{{ $gasQuality->id }}" {{ $client->gas_quality_id ==
                                    $gasQuality->id ?
                                    'selected' : '' }}>
                                    {{ $gasQuality->name }}
                                </option>
                        ...
                        <div>
                            ...
                            <select id="provider_id" name="provider_id" class="block mt-1 w-full" required>
                                ...
                                <option value="{{ $provider->id }}" {{ $client->provider_id ==
                                    $provider->id ?
                                    'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <x-text-input id="purchase_price" class="block mt-1 w-full" type="number" step="0.01"
                                name="purchase_price" value="{{ $client->price }}" disabled />
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="sale_price" class="block mt-1 w-full" type="number" step="0.01"
                                name="sale_price" value="{{ $client->sale_price }}" disabled />
                        </div>
                    </div>
